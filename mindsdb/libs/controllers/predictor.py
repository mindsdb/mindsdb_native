...
from mindsdb.libs.helpers.general_helpers import check_for_updates, deprecated
from mindsdb.libs.controllers.functional import (export_storage, export_predictor,
...
class Predictor:
    ...
    @deprecated(reason='Use controllers.functional.export_storage instead')
    ...
    @deprecated(reason='Use controllers.functional.export_predictor instead')
    ...
    @deprecated(reason='Use controllers.functional.import_model instead')
