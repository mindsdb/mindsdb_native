...
class TestTypeDeductor(unittest.TestCase):
    def test_type_deduction(self):
        ...
        for col_name in df.columns:
            ...
            assert stats_v2[col_name]['typing']['data_type'] == expected_type, '{}, {} != {}'.format(col_name, expected_type, stats_v2[col_name]['typing']['data_type'])
            assert stats_v2[col_name]['typing']['data_subtype'] == expected_subtype, '{}, {} != {}'.format(col_name, expected_subtype, stats_v2[col_name]['typing']['data_subtype'])
